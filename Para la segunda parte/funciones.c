...
int funcion_getStringTelefono(char mensaje[],char input[])
{
    ...
    do
    {
        if(!funcion_getStringNumeros("Ingrese el numero de telefono(Sin guion y con 8 caracteres)",aux))
        {
        ...
        {
            printf("Error, el telefono solo puede tener 8 caracteres!!!\n");
        }
...
int searchEmpty(eEmpleado lista[],int tam)
{
    int index = -1;
    for(int i=0; i< tam ; i++)
    {
